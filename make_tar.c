...
int add_to_archive(char *fname, int o_file, int depth, char *true_name)
//Добавляет файл fname в архив arc. В заголовочном блоке архива указывается либо true_name, либо fname (если true_name=="")
{
	//Блок заголовка
